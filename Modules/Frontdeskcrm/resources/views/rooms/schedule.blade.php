    ...
    <div class="card shadow border-0">
        ...
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-sm btn-gold ms-2" onclick="window.loadCalendarData()"><i class="fas fa-sync-alt"></i> Refresh</button>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive" style="max-height: 650px; overflow-y: auto;">
                <table class="table table-bordered table-sm mb-0 align-middle" id="calendar-table" style="min-width: 1500px;">
                    <thead class="bg-light sticky-top" style="z-index: 10;">
                        <tr id="calendar-header-row"></tr>
                    </thead>
                    <tbody id="calendar-body">
                        <tr><td colspan="30" class="text-center py-5"><div class="spinner-border text-gold"></div></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
...
(function() {
    ...
    function renderCalendar(data) {
        ...
        // 1. Headers
        let headers = '<th class="bg-light sticky-start border-end text-center" style="width: 120px; left: 0; z-index: 11;">Room</th>';
...
<style>
    ...
    .btn-gold { background-color: #C8A165; color: white; border: none; }
    .btn-gold:hover { background-color: #b08c54; color: white; }
