<a href="{{ route('frontdesk.dashboard') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-800 text-gray-300 {{ request()->routeIs('frontdesk.dashboard') ? 'bg-gray-800 text-white' : '' }}">
