...
@section('title', 'New City Ledger Account')
@section('page-content')

<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0 fw-bold">New City Ledger Account</h4>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('frontdesk.city-ledger.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="payment_terms" class="form-select" required>
                            ...
                            <option value="net30" {{ old('payment_terms') === 'net30' ? 'selected' : '' }} selected>Net 30</option>
                            <option value="net45" {{ old('payment_terms') === 'net45' ? 'selected' : '' }}>Net 45</option>
