        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-6">
                <div class="card border-0 shadow-lg rounded-3">
                    <div class="card-header border-0 rounded-top-3 py-3" style="background: linear-gradient(135deg, #C8A165 0%, #b08c54 100%);">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-white opacity-75 small">Fill in guest details to create a draft registration</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('frontdesk.registrations.storeWalkin') }}" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="contact_number" class="form-label fw-semibold text-dark">Contact Number <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-end-0">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="check_in" class="form-label fw-semibold text-dark">Check-in Date <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-end-0">
                                    ...
                                    <div class="col-md-6">
                                        <label for="check_out" class="form-label fw-semibold text-dark">Check-out Date <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-end-0">
                                                <i class="fas fa-sign-out-alt text-muted"></i>
                                            </span>
                                            <input type="date" class="form-control @error('check_out') is-invalid @enderror" 
                                                   name="check_out" value="{{ old('check_out', now()->addDay()->format('Y-m-d')) }}" 
                                                   required>
                                            @error('check_out')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                            ...
                            {{-- Info Alert --}}
                            <div class="alert alert-info border-0 bg-info bg-opacity-10 border-start border-3 border-info rounded-2 mb-4">
                                <div class="d-flex">
                                    <i class="fas fa-info-circle text-info mt-1 me-3"></i>
                                    <div>
                                        <strong class="d-block mb-1">Important Note</strong>
                                        Submitting this form creates a "Draft" registration. You will be redirected to finalize the room and rate immediately.
                                    </div>
                                </div>
                            </div>
        ...
        fetch(`{{ route('frontdesk.registrations.lookup') }}?phone=${encodeURIComponent(phone)}`)
            ...
            .then(data => {
                if (data.found) {
                    ...
                    feedbackMsg.innerHTML = '<i class="fas fa-check-circle text-success me-1"></i> Returning guest found! Details auto-filled.';
                    ...
                    if(data.guest.gender) {
                        ...
                        setTimeout(() => genderSelect.classList.remove('bg-success', 'bg-opacity-10'), 1500);
                    }

                } else {
                    // Not Found (New Guest)
                    feedbackMsg.innerHTML = '<i class="fas fa-user-plus text-muted me-1"></i> New guest. Please complete all fields.';
                    feedbackMsg.className = 'form-text text-muted mt-1';
                }
            })
            .catch(error => {
