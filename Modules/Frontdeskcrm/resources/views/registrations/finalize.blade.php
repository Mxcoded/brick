                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select @error('room_id') is-invalid @enderror"
                                                    name="room_id" id="room_id" onchange="updateRoomRate(this)">
                                                            ...
                                                            <td class="pe-4">
                                                                <select
                                                                    ...
                                                                    <option value="checked_in"
                                                                        @selected(old('group_members.' . $member->id . '.status', 'checked_in') == 'checked_in')>
                                                                        Check-in
                                                                    </option>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="payment_method"
                                                ...
                                                <option value="credit" @selected(old('payment_method') == 'credit')>Credit from other
                                                    branches</option>
                                            </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateRoomRate(selectElement) {
                ...
                // Find the rate input in the same container/row
                // This assumes your rate input has id="room_rate" (for lead)
                const rateInput = document.getElementById('room_rate');

                if (price && rateInput) {
                    // Format with commas if you use that js helper we added earlier
