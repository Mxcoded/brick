...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 fw-bold">
                <i class="fas fa-user-plus me-2 text-primary"></i>Add New Guest
            </h1>
            <p class="text-muted mb-0">Create a new guest profile</p>
        </div>
    ...
    <form action="{{ route('frontdesk.guests.store') }}" method="POST">
        @csrf
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nationality" class="form-control" value="{{ old('nationality') }}" placeholder="e.g., Nigerian">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">ID Type</label>
                        <select name="identification_type" class="form-select">
                            <option value="">Select</option>
                            <option value="NIN" {{ old('identification_type') == 'NIN' ? 'selected' : '' }}>National ID (NIN)</option>
                            ...
                            <option value="Voter's Card" {{ old('identification_type') == "Voter's Card" ? 'selected' : '' }}>Voter's Card</option>
                        </select>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="home_address" class="form-control" value="{{ old('home_address') }}">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="emergency_relationship" class="form-control" value="{{ old('emergency_relationship') }}" placeholder="e.g., Spouse, Parent">
                    </div>
                    <div class="col-md-4">
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('frontdesk.guests.index') }}" class="btn btn-outline-secondary btn-lg">
