...
@section('content')
   ...
   <form action="{{ route('maintenance.update', $maintenanceLog->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $maintenanceLog->location) }}" required>
            @error('location')
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" name="complaint_datetime" class="form-control @error('complaint_datetime') is-invalid @enderror" value="{{ old('complaint_datetime', $maintenanceLog->complaint_datetime->format('Y-m-d\TH:i')) }}" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="lodged_by" class="form-control @error('lodged_by') is-invalid @enderror" value="{{ old('lodged_by', $maintenanceLog->lodged_by) }}" required>
            @error('lodged_by')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" name="received_by" class="form-control @error('received_by') is-invalid @enderror" value="{{ old('received_by', $maintenanceLog->received_by) }}" required>
            @error('received_by')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="cost_of_fixing" class="form-control @error('cost_of_fixing') is-invalid @enderror" value="{{ old('cost_of_fixing', $maintenanceLog->cost_of_fixing) }}">
        ...
        <div class="form-group">
            ...
            <input type="date" name="completion_date" class="form-control @error('completion_date') is-invalid @enderror" value="{{ old('completion_date', $maintenanceLog->completion_date) }}">
