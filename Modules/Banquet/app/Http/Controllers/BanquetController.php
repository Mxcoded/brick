...
use Modules\Banquet\Services\BanquetReportService;
...
class BanquetController extends Controller
{
    ...
    {
        return app(BanquetReportService::class)->calculateProfitMargin($totalRevenue, $expenses);
    }

    private function getReportData($startDate, $endDate)
    {
        return app(BanquetReportService::class)->getReportData($startDate, $endDate);
    }
}
