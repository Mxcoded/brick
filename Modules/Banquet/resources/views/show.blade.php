                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <div class="h6 mb-0 @if ($order->total_revenue< $order->expenses){
                                text-danger
                                }
                            @else{
                            text-success
                            }
                            @endif">₦{{ number_format($order->expenses, 2) }}</div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading{{ $day->id }}">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" 
                                    ...
                                    {{ $day->event_date->format('F j, Y') }} - {{ $day->event_description ?? 'Event Day' }}
                                </button>
                            </h2>
                                            ...
                                            <div class="col">
                                                <div class="card h-100 border-0 shadow-sm">
                                                    <div class="card-header bg-light">
                                                        <h6 class="mb-0">
                                                            <i class="fas fa-{{ $item->meal_type === 'breakfast' ? 'sun' : 'moon' }} me-2"></i>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between mb-3">
                                                            <div>
                                                                ...
                                                                <div class="h5 text-primary">₦{{ number_format($item->total_price, 2) }}</div>
                                                            </div>
                                                            <div class="text-end">
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 mb-3">
                                                            @foreach (json_decode($item->menu_items, true) as $menu)
                                                                <span class="badge bg-primary-subtle text-primary">{{ $menu }}</span>
                                                            @endforeach
                                                        </div>
                                                        ...
                                                        @if ($item->dietary_restrictions)
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2">
                                                                @foreach (json_decode($item->dietary_restrictions, true) as $restriction)
                                                                    <span class="badge bg-warning-subtle text-warning">{{ $restriction }}</span>
                                                                @endforeach
                                                            </div>
                                                        @endif
                                                    </div>
