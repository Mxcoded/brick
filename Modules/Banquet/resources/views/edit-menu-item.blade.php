...
@section('current-breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">Update Menu Item-#{{ $order->order_id }}</li>
@endsection
...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <h1 class="fw-bold display-5 text-primary">
            ...
            {{ $menuItem ? 'Edit' : 'Add' }} Menu Item for Order #{{ $order->order_id }}
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <form action="{{ $menuItem ? route('banquet.orders.update-menu-item', [$order->order_id, $day->id, $menuItem->id]) : route('banquet.orders.store-menu-item', [$order->order_id, $day->id]) }}"
                  method="POST">
                @csrf
                @if($menuItem)
                    @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-3">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-2"></i>{{ $menuItem ? 'Update' : 'Save' }} Menu Item
                    </button>
