...
<div class="container-fluid py-4 banquet-theme">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 fw-bold text-charcoal">
                <i class="fas fa-user-plus me-2 text-gold"></i>Add New Customer
            </h1>
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <form action="{{ route('banquet.customers.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('banquet.customers.index') }}" class="btn btn-outline-charcoal btn-lg">
