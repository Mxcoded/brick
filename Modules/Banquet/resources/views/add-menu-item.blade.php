...
@section('current-breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Add Menu Items</li>
@endsection
...
<div class="container-fluid px-4 banquet-theme">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <h1 class="fw-bold display-5 text-charcoal">
            <i class="fas fa-utensils me-3 text-gold"></i>Add Menu Item
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-gold text-white py-3">
            <h5 class="card-title mb-0"><i class="fas fa-plus-circle me-2"></i>Menu Details</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('banquet.orders.store-menu-item', [$order->order_id, $day->id]) }}" method="POST">
                    ...
                    <div id="menu-items-container" class="mb-3">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" name="menu_items[]" 
                                   class="form-control" 
                                   value="{{ $item }}" 
                                   placeholder="Enter menu item description (e.g., Jollof Rice)"
                                   required>
                            @if($loop->first)
                ...
                <div class="d-flex justify-content-end gap-3">
                    <a href="{{ route('banquet.orders.index') }}" class="btn btn-outline-charcoal btn-lg">
                        Cancel
                    </a>
