...
@endphp
<table style="width: 100%; border: 0; border-bottom: 2px solid #C8A165; padding-bottom: 10px; margin-bottom: 15px;">
    <tr>
        ...
        <td style="border: 0; text-align: right; vertical-align: top;">
            <h2 style="margin: 0; font-size: 14px; color: #b8860b; font-weight: bold;">{{ $docTitle ?? 'Agreement' }}</h2>
