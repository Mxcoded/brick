...
<div class="container-fluid my-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
        <div>
            <h1 class="mb-1">Edit Training Record</h1>
            <p class="text-muted mb-0">{{ $trainingRecord->course_name }}</p>
        </div>
    ...
    <form method="POST" action="{{ route('staff.training.update', $trainingRecord) }}" class="card shadow-sm">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <select name="employee_id" id="employee_id" class="form-select @error('employee_id') is-invalid @enderror" required>
                        ...
                        @foreach ($employees as $emp)
                            <option value="{{ $emp->id }}" {{ old('employee_id', $trainingRecord->employee_id) == $emp->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="course_name" id="course_name" class="form-control @error('course_name') is-invalid @enderror"
                           value="{{ old('course_name', $trainingRecord->course_name) }}" required>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="provider" id="provider" class="form-control @error('provider') is-invalid @enderror"
                           value="{{ old('provider', $trainingRecord->provider) }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="training_type" id="training_type" class="form-select @error('training_type') is-invalid @enderror" required>
                        <option value="internal" {{ old('training_type', $trainingRecord->training_type) === 'internal' ? 'selected' : '' }}>Internal</option>
                        <option value="external" {{ old('training_type', $trainingRecord->training_type) === 'external' ? 'selected' : '' }}>External</option>
                        <option value="certification" {{ old('training_type', $trainingRecord->training_type) === 'certification' ? 'selected' : '' }}>Certification</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                        <option value="enrolled" {{ old('status', $trainingRecord->status) === 'enrolled' ? 'selected' : '' }}>Enrolled</option>
                        <option value="in_progress" {{ old('status', $trainingRecord->status) === 'in_progress' ? 'selected' : '' }}>In Progress</option>
                        <option value="completed" {{ old('status', $trainingRecord->status) === 'completed' ? 'selected' : '' }}>Completed</option>
                        <option value="cancelled" {{ old('status', $trainingRecord->status) === 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                    </select>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    ...
                    <input type="date" name="start_date" id="start_date" class="form-control @error('start_date') is-invalid @enderror"
                           value="{{ old('start_date', $trainingRecord->start_date->format('Y-m-d')) }}" required>
                    @error('start_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label for="end_date" class="form-label">End Date</label>
                    <input type="date" name="end_date" id="end_date" class="form-control @error('end_date') is-invalid @enderror"
                           value="{{ old('end_date', $trainingRecord->end_date?->format('Y-m-d')) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="duration_hours" id="duration_hours" step="0.1" min="0"
                           ...
                           value="{{ old('duration_hours', $trainingRecord->duration_hours) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="expiry_date" id="expiry_date" class="form-control @error('expiry_date') is-invalid @enderror"
                           value="{{ old('expiry_date', $trainingRecord->expiry_date?->format('Y-m-d')) }}">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="certification_name" id="certification_name" class="form-control @error('certification_name') is-invalid @enderror"
                           value="{{ old('certification_name', $trainingRecord->certification_name) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="certification_url" id="certification_url" class="form-control @error('certification_url') is-invalid @enderror"
                           value="{{ old('certification_url', $trainingRecord->certification_url) }}" placeholder="https://">
            ...
            <div class="mb-4">
                ...
                <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $trainingRecord->notes) }}</textarea>
