...
<div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name" class="form-label">Name <small class="text-muted"><i>(Surname first)</i></small></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="e.g. john.doe@example.com"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="place_of_birth" id="place_of_birth" class="form-control" placeholder="e.g. Lagos"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="state_of_origin" id="state_of_origin" class="form-control" placeholder="e.g. Lagos State"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nationality" id="nationality" class="form-control" placeholder="e.g. Nigerian"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="marital_status" id="marital_status" class="form-select" required>
                        <option value="" disabled {{ !old('marital_status', $employee->marital_status ?? '') ? 'selected' : '' }}>Select Status</option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="blood_group" id="blood_group" class="form-control" placeholder="e.g. O+"
                        value="{{ old('blood_group', $employee->blood_group ?? '') }}" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="e.g. +2348012345678"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="position" id="position" class="form-control" placeholder="e.g. Software Engineer"
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="residential_address" id="residential_address" class="form-control" rows="3" placeholder="Enter full address" required>{{ old('residential_address', $employee->residential_address ?? '') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="next_of_kin_name" id="next_of_kin_name" class="form-control" placeholder="e.g. Jane Doe"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="next_of_kin_phone" id="next_of_kin_phone" class="form-control" placeholder="e.g. +2348012345678"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="ice_contact_name" id="ice_contact_name" class="form-control" placeholder="e.g. John Smith"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="ice_contact_phone" id="ice_contact_phone" class="form-control" placeholder="e.g. +2348012345678"
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="end_date" class="form-label">End Date <small class="text-muted">(Leave blank if active)</small></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="branch_name" id="branch_name" class="form-control" placeholder="e.g. Lagos Branch"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="leaving_reason" id="leaving_reason" class="form-select">
                        <option value="" {{ !old('leaving_reason', $employee->leaving_reason ?? '') ? 'selected' : '' }}>None</option>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="note_for_leaving" id="note_for_leaving" class="form-control" rows="3" placeholder="e.g. Reason for resignation or transfer details">{{ old('note_for_leaving', $employee->note_for_leaving ?? '') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    @if ($employee->profile_image ?? false)
                        <small class="text-muted">Current: <a href="{{ Storage::url($employee->profile_image) }}" target="_blank">View</a></small>
                    @endif
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    @if ($employee->cv_path ?? false)
                        <small class="text-muted">Current: <a href="{{ Storage::url($employee->cv_path) }}" target="_blank">View</a></small>
                    @endif
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="file" name="resignation_letter" id="resignation_letter" class="form-control" accept=".pdf,.doc,.docx">
                    @if ($employee->resignation_letter ?? false)
                        <small class="text-muted">Current: <a href="{{ Storage::url($employee->resignation_letter) }}" target="_blank">View</a></small>
                    @endif
                </div>
            </div>
        </div>
