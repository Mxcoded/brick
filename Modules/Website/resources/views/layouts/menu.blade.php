...
<a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#websiteAdminSubmenu" role="button"
   aria-expanded="{{ (request()->routeIs('website.admin.*') && !request()->routeIs('website.admin.room-types.*') && !request()->routeIs('website.admin.rooms.*') && !request()->routeIs('website.admin.inventory.*') && !request()->routeIs('website.admin.amenities.*')) ? 'true' : 'false' }}" aria-controls="websiteAdminSubmenu">
    <i class="fas fa-globe fa-fw"></i>
    <span>Website &amp; Bookings</span>
    <i class="fas fa-chevron-down"></i>
</a>
<div class="collapse {{ (request()->routeIs('website.admin.*') && !request()->routeIs('website.admin.room-types.*') && !request()->routeIs('website.admin.rooms.*') && !request()->routeIs('website.admin.inventory.*') && !request()->routeIs('website.admin.amenities.*')) ? 'show' : '' }}" id="websiteAdminSubmenu">
