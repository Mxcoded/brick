                            ...
                            @forelse($rooms as $room)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span
                                                class="badge bg-secondary bg-opacity-10 text-secondary px-3">{{ ucfirst($room->status) }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($room->is_featured)
                                            <span class="badge bg-warning text-dark"><i class="fas fa-star me-1"></i>
                                                Featured</span>
                                        @endif
                                    </td>
                                    <td class="text-end pe-4">
                                        ...
                                        <i class="fas fa-eye"></i>
                                            ...
                                            <a href="{{ route('website.admin.rooms.edit', $room->id) }}"
                                                class="btn btn-sm btn-outline-secondary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('website.admin.rooms.destroy', $room->id) }}"
                                                method="POST"
