            ...
            <div class="card-body">
                ...
                <form action="{{ route('website.admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Deluxe Suite" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="size" class="form-control" value="{{ old('size') }}" placeholder="e.g. 45 sqm">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            @php 
                                $amenitiesList = ['Free Wi-Fi', 'Breakfast Included', 'Air Conditioning', 'Smart TV', 'Mini Bar', 'Ocean View', 'Room Service', 'Gym Access', 'Swimming Pool'];
                            @endphp
