                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="rate_code_id" class="form-select">
                                        ...
                                        @foreach($rateCodes as $rc)
                                            <option value="{{ $rc->id }}" {{ old('rate_code_id', $roomType->rate_code_id) == $rc->id ? 'selected' : '' }}>
                                                {{ $rc->name }} ({{ $rc->code }})
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="base_occupancy" class="form-control" value="{{ old('base_occupancy', $roomType->base_occupancy ?? 2) }}" min="1">
                                        <span class="input-group-text">guests</span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">₦</span>
                                        <input type="number" name="extra_adult_fee" class="form-control" value="{{ old('extra_adult_fee', $roomType->extra_adult_fee ?? 0) }}" min="0" step="0.01">
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">₦</span>
                                        <input type="number" name="extra_child_fee" class="form-control" value="{{ old('extra_child_fee', $roomType->extra_child_fee ?? 0) }}" min="0" step="0.01">
                                    </div>
