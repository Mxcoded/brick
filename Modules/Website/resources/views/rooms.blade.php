        ...
        <div class="filters mb-5 bg-white p-4 rounded shadow-sm">
            <form action="{{ route('website.rooms') }}" method="GET" class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="min_price" name="min_price" min="0" step="100" value="{{ request('min_price') }}" placeholder="N0">
                </div>
                <div class="col-md-3">
                    <label for="max_price" class="form-label">Max Price</label>
                    <input type="number" class="form-control" id="max_price" name="max_price" min="0" step="100" value="{{ request('max_price') }}" placeholder="N5000">
                </div>
                <div class="col-md-3">
                    ...
                    <div class="room-card card border-0 shadow-sm overflow-hidden h-100">
                        <div class="row g-0 h-100">
                            <div class="col-md-6 position-relative">
                                <img src="{{ $room->image }}" class="img-fluid h-100 w-100 object-fit-cover" alt="{{ $room->name }}" loading="lazy">
                                <div class="price-badge position-absolute top-0 end-0 bg-primary text-white p-3">
                                    <span class="d-block fs-4 fw-bold">${{ number_format($room->price_per_night) }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="card-body p-4 d-flex flex-column h-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-auto">
                                        <a href="{{ route('website.room.details', $room->id) }}" class="text-decoration-none text-primary">
                                            View Details <i class="fas fa-arrow-right ms-1"></i>
                                        </a>
                                        <a href="{{ route('website.booking.form', ['room_id' => $room->id]) }}" class="btn btn-primary btn-sm">
                                            Book Now
                                        </a>
                                    </div>
                                </div>
