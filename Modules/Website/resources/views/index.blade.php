...
<section class="hero-section position-relative overflow-hidden">
    <div id="heroCarousel" class="carousel slide h-100" data-bs-ride="carousel">
        <div class="carousel-inner h-100">
            ...
            <div class="carousel-item active h-100">
                ...
                <div class="container h-100 d-flex align-items-center position-relative z-index-1">
                    <div class="hero-content text-white text-center w-100 pt-5 pb-6">
                        ...
                        <div class="quick-booking-form bg-white p-4 rounded shadow mx-auto mt-4" style="max-width: 900px;">
                            <form action="{{ route('website.booking.form') }}" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3">
            ...
            <div class="carousel-item h-100">
                <div class="hero-slide h-100" style="background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('{{ Storage::url('images/hotel-hero-2.png') }}') center/cover no-repeat;"></div>
                <div class="container h-100 d-flex align-items-center">
                    <div class="hero-content text-white text-center w-100">
                        ...
                        <div class="d-flex justify-content-center gap-3 mb-5">
                            <a href="{{ route('website.amenities') }}" class="btn btn-outline-light btn-lg px-5 py-3">Explore Amenities</a>
                        ...
                        <div class="quick-booking-form bg-white p-4 rounded shadow mx-auto mt-4" style="max-width: 900px;">
                            <form action="{{ route('website.booking.form') }}" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="check_in_2" name="check_in" min="{{ date('Y-m-d') }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="check_out_2" class="form-label">Check-Out</label>
                                    <input type="date" class="form-control" id="check_out_2" name="check_out" min="{{ date('Y-m-d', strtotime('+1 day')) }}" required>
                                </div>
                                <div class="col-md-3">
    ...
    <section id="featured-rooms" class="py-5 py-lg-7 bg-light">
        <div class="container">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="room-card card border-0 shadow-sm h-100 overflow-hidden">
                        <div class="room-img-container position-relative overflow-hidden">
                            <img src="{{Storage::url( $room->image) }}" class="card-img-top room-image" alt="{{ $room->name }}">
                            ...
                            <div class="room-overlay d-flex align-items-center justify-content-center">
                                <a href="{{ route('website.room.details', $room->id) }}" class="btn btn-outline-light btn-lg">View Details</a>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer bg-white border-0">
                            <a href="{{ route('website.booking.form', ['room_id' => $room->id]) }}" class="btn btn-primary w-100">Book Now</a>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="text-center mt-5">
                <a href="{{ route('website.rooms') }}" class="btn btn-outline-primary btn-lg px-5">View All Rooms</a>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="pe-lg-5">
                        ...
                        <div class="feature-list">
                            <div class="feature-item d-flex mb-4">
                                <div class="feature-icon bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center me-4" style="width: 60px; height: 60px;">
                                    <i class="fas fa-concierge-bell fa-lg"></i>
                                </div>
                                <div>
                                    <h3 class="h5 mb-2">24/7 Concierge</h3>
                                    <p class="mb-0 text-muted">Our dedicated staff is always available to assist with your needs.</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item d-flex mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">Complimentary high-speed internet throughout the property.</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="ratio ratio-16x9 rounded overflow-hidden shadow-lg">
                        <img src="{{ asset('images/hotel-feature.jpg') }}" alt="Hotel Feature" class="img-fluid w-100 h-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 overflow-hidden dining-card">
                        <img src="{{ $option->image }}" class="card-img-top dining-image" alt="{{ $option->name }}">
                        <div class="card-body">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 order-lg-1 mb-4 mb-lg-0">
                    <div class="ratio ratio-16x9 rounded overflow-hidden shadow-lg">
                        <img src="{{ asset('images/spa.jpg') }}" alt="Spa" class="img-fluid w-100 h-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 py-lg-7 bg-dark text-white">
        <div class="container">
            <div class="section-header text-center mb-5">
                ...
                <p class="text-light mx-auto" style="max-width: 700px; opacity: 0.8;">Don't just take our word for it - hear from our satisfied guests.</p>
            </div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card bg-gray-800 p-4 h-100 rounded">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ $testimonial->guest_image }}" class="rounded-circle me-3" width="50" height="50" alt="{{ $testimonial->guest_name }}">
                            <div>
    ...
    <section class="py-5 py-lg-7 bg-primary text-white">
        <div class="container text-center">
            ...
            <p class="lead mb-5 mx-auto" style="max-width: 700px;">Book your stay today and discover the perfect blend of luxury, comfort, and exceptional service.</p>
