    ...
    <div class="container">
        ...
        <div class="row" id="Asokoro">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="text-center">
                    <h2 class="h4 mb-3">Website</h2>
                    <p><a href="{{ route('website.book') }}" target="_blank" class="btn btn-primary px-4">Book a room with us</a></p>
        ...
        <div class="row" id="Wuse">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="text-center">
                    <h2 class="h4 mb-3">Website</h2>
                    <p><a href="https://www.brickspoint.ng/rooms" target="_blank" class="btn btn-primary px-4">Book a room with us</a></p>
                    <h2 class="h4 mb-3">Address</h2>
