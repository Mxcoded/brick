...
<head>
    ...
    <title>[Staff] Booking Cancelled - {{ $booking->booking_reference }}</title>
    <style>
                                ...
                                <tr>
                                    <td style="font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;">
                                        <p style="font-size:14px; color:#666666; margin:0 0 24px 0; line-height:1.6;">
                                            Booking <strong>{{ $booking->booking_reference }}</strong> has been cancelled.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FAF8F5; margin-bottom:20px;">
                                <tr>
                                    <td style="padding:28px 28px 0 28px;">
                                        <p style="font-size:12px; font-weight:600; color:#1A1A1A; text-transform:uppercase; letter-spacing:1px; margin:0 0 16px 0; padding-bottom:10px; border-bottom:2px solid #DC2626; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;">Cancelled Reservation</p>
                                    </td>
                                </tr>
                                <tr>
                                                ...
                                                <td style="padding:11px 0; border-bottom:1px solid #EDE8E1;">
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width:60%; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:13px; color:#2D2D2D; font-weight:600; text-align:right;">{{ $booking->guest_email }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
