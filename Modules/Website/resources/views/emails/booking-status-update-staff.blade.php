...
<head>
    ...
    <title>[Staff] {{ $statusLabel }} — {{ $booking->booking_reference }}</title>
    <style>
                    ...
                    <tr>
                        <td style="padding:0;">
                            ...
                            @elseif($booking->status === 'cancelled')
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#DC2626;">
                            @else
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;">
                                        <p style="font-size:14px; color:#666666; margin:0 0 24px 0; line-height:1.6;">
                                            Booking <strong>{{ $booking->booking_reference }}</strong> status has been updated to <strong>{{ $statusLabel }}</strong>.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FAF8F5; margin-bottom:20px;">
                                <tr>
                                    <td style="padding:28px 28px 0 28px;">
                                        <p style="font-size:12px; font-weight:600; color:#1A1A1A; text-transform:uppercase; letter-spacing:1px; margin:0 0 16px 0; padding-bottom:10px; border-bottom:2px solid #C9A962; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif;">Details</p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:11px 0; border-bottom:1px solid #EDE8E1;">
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td style="width:40%; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:13px; color:#888888;">Guest</td>
                                                ...
                                                <td style="padding:11px 0; border-bottom:1px solid #EDE8E1;">
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width:60%; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:13px; color:#2D2D2D; font-weight:600; text-align:right;">{{ $booking->guest_phone }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:11px 0; border-bottom:1px solid #EDE8E1;">
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width:60%; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:13px; color:#2D2D2D; font-weight:600; text-align:right;">{{ optional($booking->roomType)->name ?? 'N/A' }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:11px 0; border-bottom:1px solid #EDE8E1;">
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width:60%; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:13px; color:#C9A962; font-weight:700; text-align:right;">&#x20A6;{{ number_format($booking->total_amount, 2) }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="width:60%; text-align:right;">
                                                                <span style="display:inline-block; background-color:{{ $booking->payment_status === 'paid' ? '#D1FAE5; color:#065F46' : '#FEF3C7; color:#92400E' }}; padding:3px 12px; font-family:'Segoe UI','Helvetica Neue',Arial,sans-serif; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.5px;">{{ ucfirst($booking->payment_status) }}</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
