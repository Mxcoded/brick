...
const Navbar = () => {
  ...
  const { auth, settings, featuredRooms, dining, og_title, meta_description } = usePage().props as unknown as PageProps;
  ...
  const navLinks = [
    { name: 'Home', path: '/frontend/' },
    { name: 'About Us', path: '/frontend/about' },
    { name: 'Gallery', path: '/frontend/gallery' },
    { name: 'Rooms', path: '/frontend/room' },
    { name: 'Restaurant', path: '/frontend/restaurant' },
    { name: 'Spa', path: '/frontend/spa' },
    { name: 'Contact', path: '/frontend/contact' },
  ];
