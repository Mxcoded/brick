...
<div class="container py-5"><i class="fas fa-dumbbell me-2"></i>
    <div class="form-container">
        ...
        <div class="form-body">
            ...
            <form method="POST" id="membershipForm" action="{{ route('gym.memberships.store') }}">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="toggle-container">
                        <div class="toggle-option {{ old('package_type', 'individual') == 'individual' ? 'active' : '' }}" data-value="individual" id="individualOption">
                            <i class="fas fa-user"></i>
                            <h5>Individual</h5>
                            <p>Perfect for solo training</p>
                        </div>
                        <div class="toggle-option {{ old('package_type') == 'couple' ? 'active' : '' }}" data-value="couple" id="coupleOption">
                            <i class="fas fa-users"></i>
                            <h5>Couple</h5>
                            <p>Great for partners</p>
                        </div>
                    </div>
                    <input type="hidden" name="package_type" id="packageType" value="{{ old('package_type', 'individual') }}">
                    @error('package_type')
                ...
                <div class="form-card">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="subscription_plan" required>
                                ...
                                <option value="quarterly" {{ old('subscription_plan') == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                                <option value="6months" {{ old('subscription_plan') == '6months' ? 'selected' : '' }}>6 Months</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <input class="form-check-input" type="radio" id="personalTrainerYes" name="personal_trainer" value="yes" {{ old('personal_trainer') == 'yes' ? 'checked' : '' }} required>
                                <label for="personalTrainerYes">Yes</label>
                                <input class="form-check-input" type="radio" id="personalTrainerNo" name="personal_trainer" value="no" {{ old('personal_trainer') == 'no' ? 'checked' : '' }} required>
                        ...
                        <div class="col-md-6 mb-3" id="sessionsSection" style="display: {{ old('personal_trainer') == 'yes' ? 'block' : 'none' }};">
                            <label class="form-label">Sessions (required if personal trainer is selected)</label>
                            <div>
                                <input class="form-check-input" type="radio" id="session1" name="sessions" value="1" {{ old('sessions') == '1' ? 'checked' : '' }}>
                                <label for="session1">1 Session</label>
                                <input class="form-check-input" type="radio" id="session6" name="sessions" value="6" {{ old('sessions') == '6' ? 'checked' : '' }}>
                                <label for="session6">6 Sessions</label>
                                <input class="form-check-input" type="radio" id="session12" name="sessions" value="12" {{ old('sessions') == '12' ? 'checked' : '' }}>
                                <label for="session12">12 Sessions</label>
                                <input class="form-check-input" type="radio" id="session20" name="sessions" value="20" {{ old('sessions') == '20' ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="payment_amount" step="0.01" min="0" value="{{ old('payment_amount') }}" required placeholder="0.00">
                            </div>
                            @error('payment_amount')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <input type="datetime-local" hidden class="form-control" name="payment_date" value="{{ old('payment_date', now()->format('Y-m-d\TH:i')) }}" required>
                        @error('payment_date')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="payment_mode" required>
                                ...
                                <option value="pos" {{ old('payment_mode') == 'pos' ? 'selected' : '' }}>POS</option>
                                <option value="crypto" {{ old('payment_mode') == 'crypto' ? 'selected' : '' }} disabled title="Coming Soon">Crypto</option>
                            </select>
                            @error('payment_mode')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="member-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="date_of_birth_1" value="{{ old('date_of_birth_1') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="gender_1" required>
                                <option value="male" {{ old('gender_1') == 'male' ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ old('gender_1') == 'female' ? 'selected' : '' }}>Female</option>
                                <option value="other" {{ old('gender_1') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('gender_1')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control" name="phone_number_1" value="{{ old('phone_number_1') }}" required placeholder="e.g., 08012345678">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" class="form-control" name="email_address_1" value="{{ old('email_address_1') }}" placeholder="name@example.com">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="home_address_1" rows="2" required>{{ old('home_address_1') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label required">Full Name</label>
                            <input type="text" class="form-control" name="emergency_contact_name_1" value="{{ old('emergency_contact_name_1') }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="emergency_contact_relationship_1" value="{{ old('emergency_contact_relationship_1') }}" required placeholder="e.g., Spouse">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label required">Phone Number</label>
                            <input type="tel" class="form-control" name="emergency_contact_number_1" value="{{ old('emergency_contact_number_1') }}" required placeholder="e.g., 08012345678">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="medical_conditions_yes_1" name="has_medical_conditions_1" value="yes" {{ old('has_medical_conditions_1') == 'yes' ? 'checked' : '' }} required>
                            <label class="form-check-label" for="medical_conditions_yes_1">Yes</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="medical_conditions_no_1" name="has_medical_conditions_1" value="no" {{ old('has_medical_conditions_1') == 'no' ? 'checked' : '' }}>
                            <label class="form-check-label" for="medical_conditions_no_1">No</label>
                        </div>
                        <div id="medical_conditions_details_1" class="mt-2" style="display: {{ old('has_medical_conditions_1') == 'yes' ? 'block' : 'none' }};">
                            <label for="medical_conditions_1" class="form-label">If yes, please specify</label>
                            <textarea class="form-control" id="medical_conditions_1" name="medical_conditions_1" rows="3">{{ old('medical_conditions_1') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_weight_loss_1" name="fitness_goals_1[]" value="Weight Loss" {{ in_array('Weight Loss', old('fitness_goals_1', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_weight_loss_1">Weight Loss</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_muscle_gain_1" name="fitness_goals_1[]" value="Muscle Gain" {{ in_array('Muscle Gain', old('fitness_goals_1', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_muscle_gain_1">Muscle Gain</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_general_fitness_1" name="fitness_goals_1[]" value="General Fitness" {{ in_array('General Fitness', old('fitness_goals_1', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_general_fitness_1">General Fitness</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_other_1" name="fitness_goals_1[]" value="Other" {{ in_array('Other', old('fitness_goals_1', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_other_1">Other</label>
                        </div>
                        <div id="fitness_goals_other_details_1" class="mt-2" style="display: {{ in_array('Other', old('fitness_goals_1', [])) ? 'block' : 'none' }};">
                            <label for="fitness_goals_other_1" class="form-label">If Other, please specify</label>
                            <input type="text" class="form-control" id="fitness_goals_other_1" name="fitness_goals_other_1" value="{{ old('fitness_goals_other_1') }}">
                ...
                <!-- Member 2 Information - Initially Hidden -->
                <div class="member-card {{ old('package_type') == 'couple' ? '' : 'hidden' }}" id="member2">
                    <div class="member-header">
                        <div class="member-icon">
                            <i class="fas fa-user"></i>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="full_name_2" value="{{ old('full_name_2') }}">
                            @error('full_name_2')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="date_of_birth_2" value="{{ old('date_of_birth_2') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" name="gender_2">
                                <option value="male" {{ old('gender_2') == 'male' ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ old('gender_2') == 'female' ? 'selected' : '' }}>Female</option>
                                <option value="other" {{ old('gender_2') == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('gender_2')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control" name="phone_number_2" value="{{ old('phone_number_2') }}" placeholder="e.g., 08012345678">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Email Address</label>
                            <input type="email" class="form-control" name="email_address_2" value="{{ old('email_address_2') }}" placeholder="name@example.com">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="home_address_2" rows="2">{{ old('home_address_2') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Full Name</label>
                            <input type="text" class="form-control" name="emergency_contact_name_2" value="{{ old('emergency_contact_name_2') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="emergency_contact_relationship_2" value="{{ old('emergency_contact_relationship_2') }}" placeholder="e.g., Spouse">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" name="emergency_contact_number_2" value="{{ old('emergency_contact_number_2') }}" placeholder="e.g., 08012345678">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="medical_conditions_yes_2" name="has_medical_conditions_2" value="yes" {{ old('has_medical_conditions_2') == 'yes' ? 'checked' : '' }}>
                            <label class="form-check-label" for="medical_conditions_yes_2">Yes</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="medical_conditions_no_2" name="has_medical_conditions_2" value="no" {{ old('has_medical_conditions_2') == 'no' ? 'checked' : '' }}>
                            <label class="form-check-label" for="medical_conditions_no_2">No</label>
                        </div>
                        <div id="medical_conditions_details_2" class="mt-2" style="display: {{ old('has_medical_conditions_2') == 'yes' ? 'block' : 'none' }};">
                            <label for="medical_conditions_2" class="form-label">If yes, please specify</label>
                            <textarea class="form-control" id="medical_conditions_2" name="medical_conditions_2" rows="3">{{ old('medical_conditions_2') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_weight_loss_2" name="fitness_goals_2[]" value="Weight Loss" {{ in_array('Weight Loss', old('fitness_goals_2', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_weight_loss_2">Weight Loss</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_muscle_gain_2" name="fitness_goals_2[]" value="Muscle Gain" {{ in_array('Muscle Gain', old('fitness_goals_2', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_muscle_gain_2">Muscle Gain</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_general_fitness_2" name="fitness_goals_2[]" value="General Fitness" {{ in_array('General Fitness', old('fitness_goals_2', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_general_fitness_2">General Fitness</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="fitness_goals_other_2" name="fitness_goals_2[]" value="Other" {{ in_array('Other', old('fitness_goals_2', [])) ? 'checked' : '' }}>
                            <label class="form-check-label" for="fitness_goals_other_2">Other</label>
                        </div>
                        <div id="fitness_goals_other_details_2" class="mt-2" style="display: {{ in_array('Other', old('fitness_goals_2', [])) ? 'block' : 'none' }};">
                            <label for="fitness_goals_other_2" class="form-label">If Other, please specify</label>
                            <input type="text" class="form-control" id="fitness_goals_other_2" name="fitness_goals_other_2" value="{{ old('fitness_goals_other_2') }}">
                ...
                <div class="d-grid mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-check-circle me-2"></i>Register Membership
                    </button>
                </div>
            </form>
